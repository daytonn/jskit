...
Mixins allow you to define common functionality that can be "mixed in" to any controller. This provides a way to share functionality without inheritance. Here is an example of a mixin that adds [CRUD]()
