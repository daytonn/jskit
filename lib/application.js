...
function ensureActionIsDefined(controller, action, name) {
...
function registerControllerEvent(controller, action, name, namespace) {
...
function registerControllerActions(controller, actions, name, namespace) {
  _(actions).each(function(action) {
    ensureActionIsDefined(controller, action, name);
    registerControllerEvent.call(this, controller, action, name, namespace);
  }, this);
}
